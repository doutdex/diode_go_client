...
type Config struct {
	...
	SBlocklists             []string         `yaml:"blocklists,omitempty" json:"blocklists,omitempty"`
	SAllowlists             []string         `yaml:"allowlists,omitempty" json:"allowlists,omitempty"`
	...
	ConfigDelete            []string         `yaml:"-" json:"-"`
	ConfigSet               []string         `yaml:"-" json:"-"`
	PublishedPorts          map[int]*Port    `yaml:"-" json:"-"`
	PublicPublishedPorts    []string         `yaml:"-" json:"-"`
	ProtectedPublishedPorts []string         `yaml:"-" json:"-"`
	PrivatePublishedPorts   []string         `yaml:"-" json:"-"`
